...
const DownloadArea = () => {
    ...
    return (
      <div className="AsideContext WhatchSec DownloadArea" id="DownloadArea">
      <h2> 
        <em>تحميل</em>
        <span>الحلقة</span>
        <a href="#" title="مسلسل See الموسم الاول الحلقة 6 السادسة مترجم">
          تحميل ومشاهدة الحلقة
          <em>6</em>
          <em>مسلسل مسلسل See | See S01</em>
          روابط تحميل مباشرة وسريعه |سيما فور أب
        </a>
      </h2>
      {/* WatchServers */}
      <div className="WatchServers">
        <ul className="TableBody ForceDownload">
          <li className="MyServers">
            <a href="#" className="DownloadURL nobind Hoverable">
              <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 479 479" style={{enableBackground: 'new 0 0 479 479'}} xmlSpace="preserve">
                <g>
                  <g>
                    <path d="M158.4,196.8c-5.3,5.3-5.3,13.8,0,19.1l71.6,71.6c2.6,2.6,6.1,4,9.5,4s6.9-1.3,9.5-4l71.6-71.6c5.3-5.3,5.3-13.8,0-19.1 s-13.8-5.3-19.1,0L253,245.3V13.5C253,6,247,0,239.5,0S226,6,226,13.5v231.8l-48.5-48.5C172.2,191.5,163.6,191.5,158.4,196.8z" />
